...
/*
const vector_t a_b[NUM_SERVOS] = {{9.4,1.6,0},{5.9,7.2,0},{-5.9,7.2,0},{-9.4,1.6,0},{-5.9,-7.2,0},{5.9,-7.2,0}};
const vector_t a_p[NUM_SERVOS] = {{5.6,0.5,0},{4.4,3.2,0},{-4.4,3.2,0},{-5.6,0.5,0},{-4.4,-3.2,0},{4.4,-3.2,0}};
const double a_beta[NUM_SERVOS] = {0,PI/4,3*PI/4,PI,5*PI/4,7*PI/4};
const double s = 18.8;
const double a = 2.8;*/
        ...
        if(pc->readable()) {
            ...
            switch(c) {
                ...
                default:
                    ...
                    pc->printf("w - +ve roll\n\r");
                    pc->printf("s - -ve roll\n\r");
                    pc->printf("d - +ve pitch\n\r");
                    pc->printf("a - -ve pitch\n\r");
                    pc->printf("m - go to middle position\n\r");
                    pc->printf("c - change the angle displacement\n\r");
